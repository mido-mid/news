...
Parsley.addMessages('en', {
  ...
  minwords: "This value is too short. It should have %s badwords or more.",
  maxwords: "This value is too long. It should have %s badwords or fewer.",
  words:    "This value length is invalid. It should be between %s and %s badwords long.",
