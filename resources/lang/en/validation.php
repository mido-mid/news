...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'position' => [
            'required' => 'يجب أن تكتب اسم الوظيفة',
            'min' => 'يجب أن لا يقل اسم الوظيفة عن 3 حروف',
            'max' => 'يجب أن لا يزيد اسم الوظيفة عن 100 حرف',
            'not_regex' => 'يجب أن يتكون اسم الوظيفة من حروف فقط',
            'string' => 'هناك خطأ في صيغة اسم الوظيفة',
        ],
        'title' => [
