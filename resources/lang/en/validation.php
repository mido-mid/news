...
return [
    ...
    */
    ...
    'custom' => [
        'media' => [
            'required' => 'يجب أن تختار الصور',
            'image' => 'يجب أن يكون الملف المرفوع هو صورة',
            'mimes' => 'jpg,jpeg,png,svg,gif يجب أن تكون الصور من نوع',
        ...
        'name' => [
            ...
            'max' => 'يجب أن لا يزيد الإسم عن 255 حرف',
            'not_regex' => 'يجب أن يتكون الإسم من حروف فقط',
            'string' => 'الإسم الذي كتيته غير مناسب',
        ],
        'title' => [
            'required' => 'يجب أن تكتب اسمك',
            'min' => 'يجب أن لا يقل العنوان عن 3 حروف',
            'max' => 'يجب أن لا يزيد الإسم عن 255 حرف',
            'not_regex' => 'يجب أن يتكون الإسم من حروف فقط',
            'string' => 'الإسم الذي كتيته غير مناسب',
        ],
        'body' => [
            ...
            'min' => 'يجب أن لا تقل تفاصيل الخبر عن 3 حروف',
            'max' => 'يجب أن لا تزيد تفاصيل الخبر عن 255 حرف',
            'not_regex' => 'يجب أن تتكون تفاصيل الخبر من حروف فقط',
            'string' => 'الإسم الذي كتيته غير مناسب',
        ],
        'author' => [
            'required' => 'يجب أن تكتب اسم الكاتب',
            'min' => 'يجب أن لا يقل اسم الكاتب عن 3 حروف',
            'max' => 'يجب أن لا يزيد اسم الكاتب عن 255 حرف',
        ...
        'email' => [
            ...
            'max' => 'يجب أن لا يزيد البريد الإلكتروني عن 255 حرف',
            'string' => 'البريد الإلكتروني الذي كتيته غير مناسب',
        ],
        'password' => [
            'required' => 'يجب أن تكتب كلمة السر الخاصة بك',
            'string' => 'كلمة السر التي كتيتها غير مناسبة',
