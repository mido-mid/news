                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mini-stat clearfix">
                                    ...
                                    <p class=" mb-0 mt-4 text-muted">Total income: $22506 <span class="float-right"><i class="fa fa-caret-up mr-1"></i>10.25%</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-9 monthly-earning-wid">
                                <div class="card" style="height: 480px;">
                                    <div class="card-body">
                                        <h4 class="card-title">Monthly Earnings</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="clearfix"></div>
                                    <a href="#" class="btn btn-sm btn-warning mt-4">View All Data</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-vertical table-nowrap mb-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-2.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2"/>
                                                Herbert C. Patton
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-3.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2"/>
                                                Mathias N. Klausen
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-4.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2"/>
                                                Nikolaj S. Henriksen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-5.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2"/>
                                                Lasse C. Overgaard
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-6.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2"/>
                                                Kasper S. Jessen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-vertical table-nowrap mb-0">
                                        ...
                                        <tr>
                                            <td>#12354781</td>
                                            <td>
                                                <img src="assets/images/products/1.jpg" alt="user-image" style="height: 48px;" class="rounded mr-2" />
                                        ...
                                        <tr>
                                            <td>#52140300</td>
                                            <td>
                                                <img src="assets/images/products/2.jpg" alt="user-image" style="height: 48px;" class="rounded mr-2" />
                                        ...
                                        <tr>
                                            <td>#96254137</td>
                                            <td>
                                                <img src="assets/images/products/3.jpg" alt="user-image" style="height: 48px;" class="rounded mr-2" />
                                        ...
                                        <tr>
                                            <td>#12365474</td>
                                            <td>
                                                <img src="assets/images/products/4.jpg" alt="user-image" style="height: 48px;" class="rounded mr-2" />
                                        ...
                                        <tr>
                                            <td>#85214796</td>
                                            <td>
                                                <img src="assets/images/products/5.jpg" alt="user-image" style="height: 48px;" class="rounded mr-2" />
                                                BeoPlay Speaker
                                            </td>
                                            <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                            <td>
